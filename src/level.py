...
from src.enemy import Dragon, Enemy
from src.misc import *
from src.particle import Animator
...
class Level:
    def __init__(self):
        ...
        self.collision_sprites = (
            pygame.sprite.Group()
        )  # sprites that interact via collisions
    ...
    def damage_player(self, amount, attack_type):
        if self.player.vulnerable:
            ...
            # spawn particles
            self.animator.generate_effect(
                self.player.rect.center, self.all_sprites, attack_type
            )
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.floor_surf = pygame.image.load(
            os.path.join("graphics", "world", "world.png")
        ).convert()
